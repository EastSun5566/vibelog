...
- A reader-first homepage, complete article archive, tag index and topic pages, adjacent-post navigation, RSS, sitemap, canonical URLs, Open Graph, responsive typography, and code styles
